'###################################################################################################################
'Test Script Name: Testcase95_EXP_09_23
'Script Description: Testcase95_EXP_09_23
...
TestScriptName = "Testcase95_EXP_09_23"
...
If JavaWindow("Oracle Retail Xstore Point").JavaButton("Enable Cash").Exist(2) Then
JavaWindow("Oracle Retail Xstore Point").JavaButton("Enable Cash").Click
	Reporter.ReportEvent micPass,"Banking","Enable cash button validated  successfully"
Else
	Reporter.ReportEvent micFail,"Banking","Enable cash button validated  successfully"
End If
