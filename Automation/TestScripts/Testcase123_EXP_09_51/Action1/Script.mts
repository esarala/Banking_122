'###################################################################################################################
'Test Script Name: Testcase123_EXP_09_51
'Script Description: Testcase123_EXP_09_51
...
TestScriptName = "Testcase123_EXP_09_51"
...
For i=1 to iRowCount
	...
	If Instr(1,CurrentTestCaseName,TestScriptName,0)>0 Then
		...
		strCollectionBagMaintenance = DataTable.Value("CollectionBagMaintenance")
		Exit For
	End If
Next
...
Call fnTestcase123_EXP_09_51(intBagReference,strCollectionBagMaintenance,intAmount)
