'###################################################################################################################
'Test Script Name: Testcase136_CH_200_01
'Script Description: Testcase136_CH_200_01
...
TestScriptName = "Testcase136_CH_200_01"
...
For i=1 to iRowCount
	...
	If Instr(1,CurrentTestCaseName,TestScriptName,0)>0 Then
		...
		intPISConfirmation = DataTable.Value("PISConfirmation")
		Exit For
	End If
Next
...
Call fnTestcase61_CH_200_01(intPISConfirmation,strLoginType,strUsername,strPassword)
...
ExitRun
 ...
 @@ hightlight id_;_2142705062_;_script infofile_;_ZIP::ssf1.xml_;_
