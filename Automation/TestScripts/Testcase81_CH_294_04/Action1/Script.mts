'###################################################################################################################
'Test Script Name: Testcase81_CH_294_04
'Script Description: Testcase81_CH_294_04
...
TestScriptName = "Testcase81_CH_294_04"
...
Call Testcase81_CH_294_04()

If JavaWindow("Oracle Retail Xstore Point").JavaEdit("Back Office Login").Exist(2) Then
	Call LoginXstore(strLoginType,strUsername,strPassword)
End If
wait 2
Call fnOpenTill()
