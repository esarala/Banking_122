'###################################################################################################################
'Test Script Name: Testcase65_CH_200_05
'Script Description: Testcase65_CH_200_05
...
TestScriptName = "Testcase65_CH_200_05"
...
If JavaWindow("Oracle Retail Xstore Point").JavaButton("Back_2").Exist(3) Then
	...
	Reporter.ReportEvent micPass,"Register Close","Back button validated successfully"
Else
	Reporter.ReportEvent micFail,"Register Close","Back button validated Unsuccessfully"
End If
