'###################################################################################################################
'Test Script Name: Testcase111_EXP_09_65
'Script Description: Testcase111_EXP_09_65
...
TestScriptName = "Testcase111_EXP_09_65"
...
'	wait 1
'End If
Call NonIMEIsaleGiftvouher(intPLU, intQty, intVoucher, intVoucherAmt)

Call LoginXstore("Backoffice",strUsername,strPassword)

Call Testcase111_EXP_09_65()
...
'RunAction "Action1 [NonIMEIsaleGiftvouher]", oneIteration
'
'Wait(3)
'
