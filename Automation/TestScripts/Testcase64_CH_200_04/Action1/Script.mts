'###################################################################################################################
'Test Script Name: Testcase64_CH_200_04
'Script Description: Testcase64_CH_200_04
...
TestScriptName = "Testcase64_CH_200_04"
...
If JavaWindow("Oracle Retail Xstore Point").JavaButton("Back").Exist(3) Then	
	...
	Reporter.ReportEvent micPass,"Banking","Declare till manually back button validated successfully"
Else
	Reporter.ReportEvent micFail,"Banking","Declare till manually back button validated Unsuccessfully"
End If
Wait(2)
