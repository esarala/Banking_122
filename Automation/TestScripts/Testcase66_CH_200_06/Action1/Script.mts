'###################################################################################################################
'Test Script Name: Testcase66_CH_200_06
'Script Description: Testcase66_CH_200_06
...
TestScriptName = "Testcase66_CH_200_06"
...
If JavaWindow("Oracle Retail Xstore Point").JavaButton("Back").Exist(3) Then
	...
	Reporter.ReportEvent micPass,"Banking Midday","Midday declaration Back button successful"
Else
	Reporter.ReportEvent micFail,"Banking Midday","Midday declaration back button Unsuccessful"
End If
