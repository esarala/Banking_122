'###################################################################################################################
'Test Script Name: Testcase101_EXP_09_114
'Script Description: Testcase101_EXP_09_114
...
TestScriptName = "Testcase101_EXP_09_114"
...
'Function Testcase101_EXP_09_114()
'
...
'Wait(2)
'
'JavaWindow("Oracle Retail Xstore Point").JavaEdit("Enter Expected Quantity").Set "20.34"
'Wait(2)
'
'WshShell1.SendKeys"{ENTER}"
'Wait(2)
...
'Wait(2)
'JavaWindow("Oracle Retail Xstore Point").JavaEdit("PIS Confirmation").Set "919616"
'Wait(2)
'WshShell1.SendKeys"{ENTER}"
'Wait(2)
'
...
'
'Wait(5)
'If Window("Oracle Retail Xstore Point").Dialog("Save Print Output As").Exist(15) Then
'	Wait(2)
