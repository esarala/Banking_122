'###################################################################################################################
'Test Script Name: Testcase107_EXP_09_56
'Script Description: Testcase107_EXP_09_56
...
TestScriptName = "Testcase109_EXP_09_58"
...
'Call NonIMEISaleBondbonus(intPLU, intVoucher, intVoucherAmt)
Call NonIMEIsaleCustcaredeclaration(intPLU, intVoucher, intVoucherAmt)

Call LoginXstore("Backoffice",strUsername,strPassword)

Call Testcase109_EXP_09_58()
...
'RunAction "Action1 [NonIMEIsaleBondBonus]", oneIteration
'Wait(3)

'RunAction "Action1 [Testcase99_EXP_09_79]", oneIteration

'RunAction "Action1 [NonIMEIsaleCustcaredeclaration]", oneIteration	
'
'Wait(3)
'
'RunAction "Action1 [Testcase99_EXP_09_79]", oneIteration
